...
//! Generated file from `ecs/components/OnPointerUpResult.proto`
...
// @@protoc_insertion_point(message:PBOnPointerUpResult)
pub struct PBOnPointerUpResult {
    // message fields
    // @@protoc_insertion_point(field:PBOnPointerUpResult.button)
    pub button: ::protobuf::EnumOrUnknown<super::ActionButton::ActionButton>,
    // @@protoc_insertion_point(field:PBOnPointerUpResult.meshName)
    pub meshName: ::std::string::String,
    // @@protoc_insertion_point(field:PBOnPointerUpResult.origin)
    pub origin: ::protobuf::MessageField<super::Vector3::Vector3>,
    // @@protoc_insertion_point(field:PBOnPointerUpResult.direction)
    pub direction: ::protobuf::MessageField<super::Vector3::Vector3>,
    // @@protoc_insertion_point(field:PBOnPointerUpResult.point)
    pub point: ::protobuf::MessageField<super::Vector3::Vector3>,
    // @@protoc_insertion_point(field:PBOnPointerUpResult.normal)
    pub normal: ::protobuf::MessageField<super::Vector3::Vector3>,
    // @@protoc_insertion_point(field:PBOnPointerUpResult.distance)
    pub distance: f32,
    // @@protoc_insertion_point(field:PBOnPointerUpResult.timestamp)
    pub timestamp: i32,
    // special fields
    // @@protoc_insertion_point(special_field:PBOnPointerUpResult.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a PBOnPointerUpResult {
    fn default() -> &'a PBOnPointerUpResult {
        <PBOnPointerUpResult as ::protobuf::Message>::default_instance()
    }
}

impl PBOnPointerUpResult {
    pub fn new() -> PBOnPointerUpResult {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "button",
            |m: &PBOnPointerUpResult| { &m.button },
            |m: &mut PBOnPointerUpResult| { &mut m.button },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "meshName",
            |m: &PBOnPointerUpResult| { &m.meshName },
            |m: &mut PBOnPointerUpResult| { &mut m.meshName },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::Vector3::Vector3>(
            "origin",
            |m: &PBOnPointerUpResult| { &m.origin },
            |m: &mut PBOnPointerUpResult| { &mut m.origin },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::Vector3::Vector3>(
            "direction",
            |m: &PBOnPointerUpResult| { &m.direction },
            |m: &mut PBOnPointerUpResult| { &mut m.direction },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::Vector3::Vector3>(
            "point",
            |m: &PBOnPointerUpResult| { &m.point },
            |m: &mut PBOnPointerUpResult| { &mut m.point },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::Vector3::Vector3>(
            "normal",
            |m: &PBOnPointerUpResult| { &m.normal },
            |m: &mut PBOnPointerUpResult| { &mut m.normal },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "distance",
            |m: &PBOnPointerUpResult| { &m.distance },
            |m: &mut PBOnPointerUpResult| { &mut m.distance },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "timestamp",
            |m: &PBOnPointerUpResult| { &m.timestamp },
            |m: &mut PBOnPointerUpResult| { &mut m.timestamp },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<PBOnPointerUpResult>(
            "PBOnPointerUpResult",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for PBOnPointerUpResult {
    const NAME: &'static str = "PBOnPointerUpResult";
    ...
    fn new() -> PBOnPointerUpResult {
        PBOnPointerUpResult::new()
    }
    ...
    fn default_instance() -> &'static PBOnPointerUpResult {
        static instance: PBOnPointerUpResult = PBOnPointerUpResult {
...
impl ::protobuf::MessageFull for PBOnPointerUpResult {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("PBOnPointerUpResult").unwrap()).clone()
    }
}

impl ::std::fmt::Display for PBOnPointerUpResult {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for PBOnPointerUpResult {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n&ecs/components/OnPointerUpResult.proto\x1a\x0fcommon/id.proto\x1a\x14\
    common/Vector3.proto\x1a\x19common/ActionButton.proto\"\x9e\x02\n\x13PBO\
    nPointerUpResult\x12%\n\x06button\x18\x02\x20\x01(\x0e2\r.ActionButtonR\
    \x06button\x12\x1a\n\x08meshName\x18\x03\x20\x01(\tR\x08meshName\x12\x20\
    \n\x06origin\x18\x04\x20\x01(\x0b2\x08.Vector3R\x06origin\x12&\n\tdirect\
    ion\x18\x05\x20\x01(\x0b2\x08.Vector3R\tdirection\x12\x1e\n\x05point\x18\
    \x06\x20\x01(\x0b2\x08.Vector3R\x05point\x12\x20\n\x06normal\x18\x07\x20\
    \x01(\x0b2\x08.Vector3R\x06normal\x12\x1a\n\x08distance\x18\x08\x20\x01(\
    \x02R\x08distance\x12\x1c\n\ttimestamp\x18\t\x20\x01(\x05R\ttimestampB\
    \x05\x80\xb5\x18\xa9\x08J\x9a\x04\n\x06\x12\x04\0\x03\x10\x01\n\x08\n\
    \x01\x0c\x12\x03\0\x03\x15\n\t\n\x02\x03\0\x12\x03\x02\0\x19\n\x08\n\x01\
    \x08\x12\x03\x03\0!\n\x0b\n\x04\x08\xd0\x86\x03\x12\x03\x03\0!\n\t\n\x02\
    \x03\x01\x12\x03\x04\0\x1e\n\t\n\x02\x03\x02\x12\x03\x05\0#\n\n\n\x02\
    \x04\0\x12\x04\x07\0\x10\x01\n\n\n\x03\x04\0\x01\x12\x03\x07\x08\x1b\n\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(PBOnPointerUpResult::generated_message_descriptor_data());
